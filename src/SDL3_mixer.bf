...
static
{
	...
	public const uint32 SDL_MIXER_MINOR_VERSION = 0;
	 ...
	 */
	public typealias MIX_InitFlags =  uint32;

	public const uint32 MIX_INIT_FLAC       = 0x00000001;
	public const uint32 MIX_INIT_MOD        = 0x00000002;
	public const uint32 MIX_INIT_MP3        = 0x00000008;
	public const uint32 MIX_INIT_OGG        = 0x00000010;
	public const uint32 MIX_INIT_MID        = 0x00000020;
	public const uint32 MIX_INIT_OPUS       = 0x00000040;
	public const uint32 MIX_INIT_WAVPACK    = 0x00000080;
	 ...
	 * \sa Mix_Quit
	 */
	[CLink] public static extern MIX_InitFlags Mix_Init(MIX_InitFlags flags);
	 ...
	 */
	public const uint32 MIX_CHANNELS    = 8;

	/* Good default values for a PC soundcard */
	public const int32 MIX_DEFAULT_FREQUENCY   = 44100;
	public const int32 MIX_DEFAULT_FORMAT      = (int32)SDL_AudioFormat.SDL_AUDIO_S16;
	public const int32 MIX_DEFAULT_CHANNELS    = 2;
	public const int32 MIX_MAX_VOLUME          = 128; /* Volume of a chunk */

	/**
	 * The internal format for an audio chunk
	 */
	[CRepr] public struct Mix_Chunk
	{
	 ...
	 */
	public enum Mix_MusicType : int32
	{
		MUS_NONE,
		MUS_WAV,
		MUS_MOD,
	 ...
	 * \sa Mix_QuerySpec
	 */
	[CLink] public static extern bool Mix_OpenAudio(SDL_AudioDeviceID devid, SDL_AudioSpec* spec);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern void Mix_PauseAudio(int32 pause_on);
	 ...
	 * \sa Mix_OpenAudio
	 */
	[CLink] public static extern bool Mix_QuerySpec(int32* frequency, SDL_AudioFormat* format, int32* channels);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_AllocateChannels(int32 numchans);
	 ...
	 * \sa Mix_FreeChunk
	 */
	[CLink] public static extern Mix_Chunk* Mix_LoadWAV_IO(SDL_IOStream* src, bool closeio);
	 ...
	 * \sa Mix_FreeChunk
	 */
	[CLink] public static extern Mix_Chunk* Mix_LoadWAV(char8* file);
	 ...
	 * \sa Mix_FreeMusic
	 */
	[CLink] public static extern Mix_Music* Mix_LoadMUS(char8* file);
	 ...
	 * \sa Mix_FreeMusic
	 */
	[CLink] public static extern Mix_Music* Mix_LoadMUS_IO(SDL_IOStream* src, bool closeio);
	 ...
	 * \sa Mix_FreeMusic
	 */
	[CLink] public static extern Mix_Music* Mix_LoadMUSType_IO(SDL_IOStream* src, Mix_MusicType type, bool closeio);
	 ...
	 * \sa Mix_FreeChunk
	 */
	[CLink] public static extern Mix_Chunk* Mix_QuickLoad_WAV(uint8* mem);
	 ...
	 * \sa Mix_FreeChunk
	 */
	[CLink] public static extern Mix_Chunk* Mix_QuickLoad_RAW(uint8* mem, uint32 len);
	 ...
	 */
	[CLink] public static extern void Mix_FreeChunk(Mix_Chunk* chunk);
	 ...
	 */
	[CLink] public static extern void Mix_FreeMusic(Mix_Music* music);
	 ...
	 */
	[CLink] public static extern char8*  Mix_GetChunkDecoder(int32 index);
	 ...
	 * \sa Mix_GetChunkDecoder
	 */
	[CLink] public static extern bool Mix_HasChunkDecoder(char8* name);
	 ...
	 */
	[CLink] public static extern char8*  Mix_GetMusicDecoder(int32 index);
	 ...
	 * \sa Mix_GetMusicDecoder
	 */
	[CLink] public static extern bool Mix_HasMusicDecoder(char8* name);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0
	 */
	[CLink] public static extern Mix_MusicType Mix_GetMusicType(Mix_Music* music);
	 ...
	 */
	[CLink] public static extern char8* Mix_GetMusicTitle(Mix_Music* music);
	 ...
	 * \sa Mix_GetMusicCopyrightTag
	 */
	[CLink] public static extern char8* Mix_GetMusicTitleTag(Mix_Music* music);
	 ...
	 * \sa Mix_GetMusicCopyrightTag
	 */
	[CLink] public static extern char8* Mix_GetMusicArtistTag(Mix_Music* music);
	 ...
	 * \sa Mix_GetMusicCopyrightTag
	 */
	[CLink] public static extern char8* Mix_GetMusicAlbumTag(Mix_Music* music);
	 ...
	 * \sa Mix_GetMusicAlbumTag
	 */
	[CLink] public static extern char8* Mix_GetMusicCopyrightTag(Mix_Music* music);

	public function void Mix_MixCallback(void* udata, uint8* stream, int32 len);
	 ...
	 * \sa Mix_HookMusic
	 */
	[CLink] public static extern void Mix_SetPostMix(Mix_MixCallback mix_func, void* arg);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern void Mix_HookMusicFinished(Mix_MusicFinishedCallback music_finished);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern void Mix_ChannelFinished(Mix_ChannelFinishedCallback channel_finished);
	 ...
	 *
	 * myeffect(int32 chan, void *stream, int32 len, void *udata);
	 *
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_RegisterEffect(int32 chan, Mix_EffectFunc_t f, Mix_EffectDone_t d, void* arg);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_UnregisterEffect(int32 channel, Mix_EffectFunc_t f);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_UnregisterAllEffects(int32 channel);

	/**
	 * Environment variable that makes some mixing effects favor speed over
	 * quality.
	 */
	public const char8* MIX_EFFECTSMAXSPEED  = "MIX_EFFECTSMAXSPEED";
	 ...
	 * \sa Mix_SetDistance
	 */
	[CLink] public static extern bool Mix_SetPanning(int32 channel, uint8 left, uint8 right);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_SetPosition(int32 channel, int16 angle, uint8 distance);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_SetDistance(int32 channel, uint8 distance);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_SetReverseStereo(int32 channel, int32 flip);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_ReserveChannels(int32 num);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_GroupChannel(int32 which, int32 tag);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_GroupChannels(int32 from, int32 to, int32 tag);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_GroupAvailable(int32 tag);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_GroupCount(int32 tag);
	 ...
	 * \sa Mix_GroupNewer
	 */
	[CLink] public static extern int32 Mix_GroupOldest(int32 tag);
	 ...
	 * \sa Mix_GroupOldest
	 */
	[CLink] public static extern int32 Mix_GroupNewer(int32 tag);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0
	 */
	[CLink] public static extern int32 Mix_PlayChannel(int32 channel, Mix_Chunk* chunk, int32 loops);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_PlayChannelTimed(int32 channel, Mix_Chunk* chunk, int32 loops, int32 ticks);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_PlayMusic(Mix_Music* music, int32 loops);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_FadeInMusic(Mix_Music* music, int32 loops, int32 ms);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_FadeInMusicPos(Mix_Music* music, int32 loops, int32 ms, double position);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0
	 */
	[CLink] public static extern int32 Mix_FadeInChannel(int32 channel, Mix_Chunk* chunk, int32 loops, int32 ms);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_FadeInChannelTimed(int32 channel, Mix_Chunk* chunk, int32 loops, int32 ms, int32 ticks);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_Volume(int32 channel, int32 volume);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_VolumeChunk(Mix_Chunk* chunk, int32 volume);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_VolumeMusic(int32 volume);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_GetMusicVolume(Mix_Music* music);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_MasterVolume(int32 volume);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern void Mix_HaltChannel(int32 channel);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern void Mix_HaltGroup(int32 tag);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_ExpireChannel(int32 channel, int32 ticks);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_FadeOutChannel(int32 which, int32 ms);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_FadeOutGroup(int32 tag, int32 ms);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_FadeOutMusic(int32 ms);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern Mix_Fading Mix_FadingChannel(int32 which);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern void Mix_Pause(int32 channel);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern void Mix_PauseGroup(int32 tag);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern void Mix_Resume(int32 channel);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern void Mix_ResumeGroup(int32 tag);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_Paused(int32 channel);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_ModMusicJumpToOrder(int32 order);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_StartTrack(Mix_Music* music, int32 track);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_GetNumTracks(Mix_Music* music);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_SetMusicPosition(double position);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern double Mix_GetMusicPosition(Mix_Music* music);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern double Mix_MusicDuration(Mix_Music* music);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern double Mix_GetMusicLoopStartTime(Mix_Music* music);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern double Mix_GetMusicLoopEndTime(Mix_Music* music);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern double Mix_GetMusicLoopLengthTime(Mix_Music* music);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern int32 Mix_Playing(int32 channel);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_SetSoundFonts(char8* paths);
	 ...
	 */
	[CLink] public static extern bool Mix_EachSoundFont(Mix_EachSoundFontCallback @function, void* data);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern bool Mix_SetTimidityCfg(char8* path);
	 ...
	 * \since This function is available since SDL_mixer 3.0.0.
	 */
	[CLink] public static extern Mix_Chunk* Mix_GetChunk(int32 channel);
